...
public class HttpClientTest {
    ...
    public static void main(String[] args)
    {
        ...
        HttpGet get = new HttpGet("http://www.zhihu.com/");
            ...
            valuePairs.add(new BasicNameValuePair("email", "wolf.fang@hotmail.com"));
            valuePairs.add(new BasicNameValuePair("password", "fang1314liang"));
            ...
            post.setHeader("Cookie", " cap_id=\"ZmM0YzY1NWUzYThkNDgyYjllYWEwMjZmYjNjZjRiNmY=|1448530446|95fe554c9ea8e3fee30484116b9081d5f832fd87\"; ");
